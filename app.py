...
with st.sidebar:
    ...
    st.markdown('<span class="version-badge">v1.2.0 RELEASE</span>', unsafe_allow_html=True)
    st.write("")
...
# FINAL FOOTER
st.markdown('<div class="disclaimer-footer">🛡️ <strong>OmniCare CDSS</strong> | Clinical Intelligence Platform v1.2.0<br>Educational Purpose Only</div>', unsafe_allow_html=True)
